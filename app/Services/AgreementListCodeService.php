        ...
        foreach ($result as $data) {
            foreach ($data->agreement_list as $data_agreement_list) {
                $datastorage[] = [
                    ...
                    'request_date' => $data_agreement_list['request_date'] ? Carbon::parse($data_agreement_list['request_date'])->toDateString() : "-",
                    'additional_request_qty_date' => $data_agreement_list['additional_request_qty_date'] ? Carbon::parse($data_agreement_list['additional_request_qty_date'])->toDateString() : "-",
