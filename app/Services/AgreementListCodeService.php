        ...
        foreach ($result as $data) {
            foreach ($data->agreement_list as $data_agreement_list) {
                $datastorage[] = [
                    ...
                    'request_date' => Carbon::parse($data_agreement_list['request_date'])->format('m/d/Y'),
                    'additional_request_qty_date' =>  Carbon::parse($data_agreement_list['additional_request_qty_date'])->format('m/d/Y'),
