...
class UserService implements UserServiceContract
{
    ...
    public function loadEmailList()
    {
        ...
        $datastorage = [];
        foreach ($result as $users) {
            if ($users->employee_notification['recieve_notification'] === true)
                $datastorage[] = [
                    'user_id' => $users['id'],
                    'emp_id' => $users['employee_id'],
                    'role_access' => $users['role_access'],
    ...
    public function loadQCIEmailList()
    {
        ...
        $datastorage = [];
        foreach ($result as $users) {
            if ($users->employee_notification['recieve_notification'] === true && $users->hris_masterlist['section_code'] === 'QCI')
                $datastorage[] = [
                    'user_id' => $users['id'],
                    'emp_id' => $users['employee_id'],
                    'role_access' => $users['role_access'],
